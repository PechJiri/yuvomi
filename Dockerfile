# Digest des Multi-Arch-Index von node:24.21.0-slim (bookworm), Stand 12.9.2026.
...
FROM node:24.21.0-slim@sha256:2fe369e969550cde8e867afc3fe370b260140cab4a23d467074295b42163d553 AS build
